...
#   echo ${input_name}
#   Rscript Codes/get_labels_AUCell.R ${input_name}
#   #Rscript Codes/get_labels_GSVA.R ${input_name} 
#   Rscript Codes/get_labels_SCINA.R ${input_name} 
#   Rscript Codes/get_integrated_labels.R ${input_name} 
# done
