...
Cholangiocyte_total <- unique(c(cholangiocyte, cholangiocytes_cl, cholangiocytes_DE))
...
Total_markers <- list(KC_total, Stellates_total, Cholangiocyte_total, Hepatocytes_total, 
                      endothelial_total, T_cells_total, NK_cell_total, B_cells_total)

Total_markers_names <- c('KCs', 'Stellates', 'Cholangiocytes', 'Hepatocytes', 
                         'endothelial_cells' , 'T_cells' , 'NK_cells' ,'B_cells')

names(Total_markers) <- Total_markers_names
lapply(Total_markers, head)
...
Total_markers_converted_df <- sapply(1:length(Total_markers), 
                                     function(i){
                                       print('#################')
                                       print(Total_markers_names[i])
                                       human_markers <- Total_markers[[i]]
