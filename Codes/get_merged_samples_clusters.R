...
merged_rat_clusters <- readRDS('~/merged_rat_clusters.rds')
lapply(merged_rat_clusters$sample_type, head)

merged_rat_samples = readRDS('Results/preproc_rats/merged/merged_rat_samples.rds')
levels(merged_rat_samples)
